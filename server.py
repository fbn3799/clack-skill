...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "- NEVER generate or simulate user replies. When you ask the user a question, STOP. "
    "Do not write 'User:', do not imagine what the user might say, do not continue the conversation on their behalf. "
    "Your response ends after your own words.\n"
